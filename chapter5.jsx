...
const WEEKS = [
  {
    ...
    training: 'מטרת השבוע היא להוריד עומס מהגוף, לא להעמיס עליו עוד. תנועה קלה בלבד אם זה מרגיש לך טוב.',
    cardio: 'הליכה של 20-30 דקות, 4 פעמים בשבוע',
  ...
  },
  {
    ...
    training: 'להמשיך עם תנועה קלה ועקבית - הליכה, מתיחות או כל פעילות שמרגישה נעימה ולא מכבידה.',
    cardio: 'הליכה 30-40 דקות, 4 פעמים בשבוע',
  ...
  },
  {
    ...
    training: 'לבנות יציבות בתנועה ובשגרה - לא צריך לדחוף את הגוף, אלא להרגיש איך הוא מגיב כשיש יותר סדר.',
    cardio: 'הליכה 40-60 דקות, 5 פעמים בשבוע, לפי היכולת והלו"ז שלך',
    lifestyle: 'תמונת "לפני" ומדידות אם מתאים לך. נשימות 10 דקות בבוקר + 3 דקות לפני שינה.',
  ...
  },
  {
    ...
    training: 'להסתכל אחורה על 4 השבועות ולזהות מה עבד לך, מה הקל עלייך, ומה הכי תמך בגוף שלך.',
    cardio: 'לפי תחושה',
          ...
          <div className="week-capsule-inner">
            ...
            <div className="two-col" style={{ marginBottom: 20 }}>
              <div style={{ background: 'var(--color-surface-elevated)', borderRadius: 'var(--radius-xl)', padding: 16 }}>
                <div style={{ fontSize: 12, fontWeight: 700, color: week.color, marginBottom: 8 }}>🚶 תנועה</div>
