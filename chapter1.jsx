...
const CYCLE_PHASES = [
  ...
  },
  {
    ...
    desc: 'זה השלב של התסמינים שלפני הווסת. יותר חשקים, יותר אגירת מים, נפיחות ותנודות מצב רוח.',
...
function MacroVisual() {
  const items = [
    ['protein', 'חלבון', 'בונה ומתחזק', '4 קלוריות לגרם'],
    ['fat', 'שומן', 'מאזן ומרגיע', '9 קלוריות לגרם'],
    ['carbs', 'פחמימות', 'מדליקות אנרגיה', '4 קלוריות לגרם'],
  ];
  return (
    <div className="macro-visual card">
      {items.map(([icon, title, sub, calories], i) => (
        <div key={i} className="macro-visual-item">
          ...
          <div className="macro-visual-sub" style={{ marginTop: 4, fontWeight: 700, color: 'var(--color-accent)' }}>{calories}</div>
        </div>
      ))}
    </div>
  );
  ...
  return (
    <div>
      ...
      <div className="card" style={{ padding: '24px', marginTop: 18, marginBottom: 18 }}>
        ...
        <p style={{ fontSize: 14, color: 'var(--color-fg2)', lineHeight: 1.85, marginBottom: 12 }}>
          אלכוהול הוא לא רע, והוא לא "יהרוס לך הכל". אבל אם את רוצה לבנות שריר, לרדת בשומן ולהרגיש טוב, חשוב להבין מה בדיוק קורה בגוף בכל פעם שאת שותה כוס יין בארוחת שישי או בירה ביום שישי בערב.
        </p>
        <p style={{ fontSize: 14, color: 'var(--color-fg2)', lineHeight: 1.85, marginBottom: 12 }}>
          מבחינה קלורית, אלכוהול הוא 7 קלוריות לגרם. זה יותר מחלבון ומפחמימות. כוס יין רגילה היא בערך 120-150 קלוריות, בירה קטנה היא בערך 150, וכוס וודקה או ערק קטנה היא בערך 100. שלוש כוסות יין בארוחת שישי כבר יכולות להוסיף 400-450 קלוריות שלא ממש הרגשת.
        </p>
        <p style={{ fontSize: 14, color: 'var(--color-fg2)', lineHeight: 1.85, marginBottom: 12 }}>
    ...
    <section id="chapter-1" className="guide-section">
      ...
      <Reveal>
        <div className="card" style={{ padding: '24px', marginBottom: 42 }}>
          ...
          <p style={{ fontSize: 14, color: 'var(--color-fg2)', lineHeight: 1.85, marginBottom: 12 }}>
            אם אכלת "לפי המספר" ולא ירדת אחרי 3-4 שבועות, זה לא אומר שצריך ישר להוריד עוד קלוריות. קודם בודקים אם את אוכלת יותר ממה שנדמה לך, אם את ישנה מעט, אם את בתקופה שלפני הווסת, אם יש סטרס קבוע או אם יש בעיה הורמונלית אמיתית כמו PCOS או בלוטת תריס איטית.
          </p>
          <p style={{ fontSize: 14, color: 'var(--color-fg2)', lineHeight: 1.85, marginBottom: 0 }}>
      ...
      <Reveal>
        <div className="side-note" style={{ marginBottom: 48 }}>
          אם המחזור לא סדיר, נעלם, כאבי המחזור קשים מאוד, התסמינים שלפני הווסת קיצוניים, יש אקנה עמוק, נשירת שיער, ציפורניים שבירות או חשקים כבדים לסוכר - הרבה פעמים קודם כל צריך להסתכל על תזונה, שינה ועומס, לפני שקופצים ישר לתוספים.
        </div>
      </Reveal>

      <Reveal>
        <div className="card" style={{ padding: '24px', marginBottom: 40 }}>
          <div style={{ fontFamily: 'var(--font-display)', fontSize: 18, fontWeight: 700, marginBottom: 10 }}>סימנים שהתזונה שלך לא תומכת באיזון ההורמונלי שלך</div>
          <div className="card-grid-2">
            {[
              ...
              'תסמינים קשים מאוד לפני הווסת: חוסר B6, חוסר מגנזיום, יותר מדי סוכר ואלכוהול או מעט מדי אוכל אמיתי לאורך היום.',
        ...
        <div className="card" style={{ padding: '22px 24px', marginBottom: 28 }}>
          ...
          <div className="card-grid-2">
            {[
              ...
              'איפה הירקות? כי הם מביאים איתם סיבים, ויטמינים, שובע ונפח לארוחה.',
      ...
      <Reveal>
        <div className="card" style={{ padding: '24px', marginBottom: 26 }}>
          ...
          <p style={{ fontSize: 14, color: 'var(--color-fg2)', lineHeight: 1.85, marginBottom: 0 }}>
            הפתרון פשוט יותר ממה שנדמה: ארוחת בוקר, צהריים נורמלית, נשנוש עם חלבון אם צריך, ארוחת ערב רגילה ולא עצומה, ופחות אכילה אוטומטית אחרי הערב. נשים שעושות רק את השינוי הזה מרגישות הבדל גדול תוך שבועיים.
          </p>
        </div>
      </Reveal>
        ...
        <div className="card" style={{ padding: '24px', marginBottom: 24 }}>
          ...
          <div style={{ display: 'grid', gap: 12 }}>
            {[
              ...
              {
                title: '7. נתרן',
                body: 'חשוב במיוחד אם יש לך נטייה לאגירת נוזלים, לחץ דם או תסמינים חזקים לפני הווסת. מוצרים מעובדים מגיעים בקלות למאות רבות של מיליגרמים למנה, ולפעמים גם יותר מאלף.',
              },
            ].map((item, i) => (
              <div key={i} className="card" style={{ padding: '16px 18px' }}>
