...
const CYCLE_PHASES = [
  ...
  },
  {
    ...
    train: ['אימוני כוח עדיין חשובים, אבל לפעמים נכון להוריד ציפייה לביצועי שיא', 'אם הגוף מרגיש כבד, אפשר לעבוד נקי ומדויק במקום אגרסיבי', 'יותר הליכה, יותר התאוששות, פחות מאבק', 'אם את מרגישה שבשבוע הזה את צריכה קצת יותר מנוחה, זה לא כישלון אלא פיזיולוגיה'],
      ...
      <div>
        <div className="card" style={{ padding: '24px', marginBottom: 18 }}>
          ...
          <p style={{ fontSize: 14, color: 'var(--color-fg2)', lineHeight: 1.85, marginBottom: 0 }}>
            אישה שמתאמנת בכלל צריכה בערך 1.4-1.6 גרם חלבון לקילו. אישה שמתאמנת כוח או רוצה לבנות שריר צריכה בערך 1.6-2.0 גרם לקילו. בגרעון קלורי, לעיתים אפילו 2.0-2.4 גרם לקילו כדי להגן על מסת השריר.
          </p>
        </div>
        <MacroVisual />
    ...
    <section id="chapter-1" className="guide-section">
      ...
      <Reveal delay={0.1}>
        <div className="card" style={{ padding: '24px', marginBottom: 24 }}>
          ...
          <p style={{ fontSize: 14, color: 'var(--color-fg2)', lineHeight: 1.85, marginBottom: 0 }}>
            קילו שומן הוא בערך 7,700 קלוריות. גרעון של 500 קלוריות ביום יוצר בערך 3,500 קלוריות בשבוע, כלומר סביב חצי קילו. זה לא קסם. זה חשבון.
          </p>
        </div>
      </Reveal>
