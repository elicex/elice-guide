...
const BLOATING_TYPES = [
  {
    ...
    cause: 'כשיש קושי בפירוק או בעיכול של מזונות מסוימים, חלקם ממשיכים למעי הגס ושם עוברים תסיסה על ידי חיידקי המעי. התוצאה יכולה להיות גזים, לחץ ותחושת נפיחות. טריגרים נפוצים הם מזונות מקבוצת FODMAP, אכילה מהירה, ולעיתים גם רגישות עיכול שדורשת בירור.',
    focus: 'ביומיום זה בדרך כלל נראה כמו בטן שמתנפחת אחרי ארוחות מסוימות, במיוחד אם אכלת מהר, אכלת בחוץ, או שילבת כמה מזונות שמכבידים עלייך.',
    solutions: [
      'להאט את קצב האכילה - לעיסה 20-30 פעם לכל ביס',
      'יומן מזון לשבועיים לזיהוי טריגרים אישיים',
      'תה נענע, ג\'ינג\'ר או שומר אחרי ארוחה עשוי להקל',
      'חומץ תפוחים מדולל במים 10 דקות לפני הארוחה (אם אין צרבות)',
      'אם הבעיה חמורה - בדיקת נשיפה ל-SIBO אצל גסטרואנטרולוג',
    ],
    firstStep: 'במשך שבוע אחד האטי את קצב האכילה וכתבי לעצמך אילו ארוחות מנפחות אותך יותר מכול. רק מהמעקב הזה אפשר ללמוד הרבה.',
  },
  {
    id: 'hormonal',
    ...
    cause: 'לקראת הווסת חלים שינויים הורמונליים שיכולים להשפיע על תנועתיות המעי, על אגירת נוזלים ועל תחושת הכבדות בגוף. לכן אצל חלק מהנשים מופיעים יחד נפיחות, רגישות בשדיים ושינויים באנרגיה או במצב הרוח.',
    focus: 'ביומיום זה נראה כמו שבוע שבו שום מכנס לא יושב אותו דבר, הגוף מרגיש מלא מים, ויש תחושה שאת "עושה הכול נכון" ועדיין נפוחה.',
    solutions: [
      ...
      'זרעי פשתן טחונים יכולים להשתלב היטב בתפריט השבועי',
      'אימון כוח מתון בימים האלה יכול לעזור בתחושת הכבדות ובוויסות',
    ],
    firstStep: 'עקבי במשך שני מחזורים אחרי הימים שבהם הנפיחות מתחילה ונרגעת. ברגע שרואים את הדפוס, הרבה יותר קל להיערך אליו ולא להילחץ ממנו.',
  },
  {
    id: 'constipation',
    title: 'נפיחות עצירות',
    ...
    focus: 'ביומיום זה מרגיש כמו בטן כבדה יותר ויותר לאורך היום, תחושת "תקיעות", וחוסר הקלה אמיתי גם אחרי ארוחה קלה.',
    solutions: [
      'שתי כוסות מים גדולות על קיבה ריקה לפני הקפה - כל יום',
      'כף זרעי פשתן טחונים ביום (מוסיפה ליוגורט, שייק, סלט)',
      'מגנזיום ציטראט 300-400 מ"ג בערב עשוי לעזור, בהתאם להתאמה אישית',
      'הליכה של 20 דקות אחרי ארוחת הבוקר יכולה לסייע לתנועתיות',
      'שעת שירותים קבועה בבוקר - המעי לומד הרגל',
      'לבדוק TSH, FT3, FT4 אם הבעיה קיצונית',
    ],
    firstStep: 'התחילי משלושה דברים פשוטים: שתי כוסות מים בבוקר, הליכה קצרה אחרי ארוחת הבוקר, וכף זרעי פשתן טחונים ביום.',
  },
  {
    id: 'sensitivity',
    ...
    cause: 'זה לא תמיד מצב של אלרגיה קלאסית. לפעמים מדובר ברגישות או קושי בעיכול של מזון מסוים, ולפעמים בגירוי של מערכת העיכול שמופיע אחרי אכילה. טריגרים נפוצים יכולים להיות לקטוז, גלוטן, ביצים, סויה או מזונות עתירי FODMAP.',
    focus: 'ביומיום זה נראה כמו מצב שבו את כבר "חושדת" במזון מסוים, אבל לא בטוחה אם זו באמת הבעיה או רק צירוף מקרים שחוזר על עצמו.',
    solutions: [
      'דיאטת אלימינציה 3 שבועות - מסירים גלוטן, חלב, ביצים, סויה, סוכר, אלכוהול',
      'אחרי 3 שבועות - מחזירים מזון אחד כל 3 ימים ובודקים',
      'בחלק מהמקרים אפשר לשקול ליווי מקצועי ותוספים מותאמים אישית',
      'לצמצם מזון מעובד בתקופת הבדיקה',
      'בדיקות דם לרגישויות לא תמיד נותנות תמונה מלאה - תהליך מסודר עדיף',
    ],
    firstStep: 'בחרי מזון אחד שנראה לך חשוד במיוחד, ונסי לעקוב אחריו במשך שבוע לפני שאת מוציאה חצי תפריט. בהירות עדיפה על פאניקה.',
  },
  {
    id: 'stress',
    ...
    cause: 'במצבי עומס מתמשכים הגוף עלול להגיב בשיבוש של תיאבון, שינה, עיכול ותחושת נפיחות. לעיתים זו לא תגובה למזון מסוים, אלא למערכת עצבים שנמצאת בעומס לאורך זמן.',
    focus: 'ביומיום זה מרגיש כמו בטן שמגיבה לעומס, לחוסר שינה, לימים עמוסים או לתקופות רגשיות, גם אם האוכל עצמו לא השתנה מאוד.',
    solutions: [
      ...
      'הליכה יומית בלי טלפון ל-20 דקות היא כלי פשוט ויעיל',
    ],
    firstStep: 'לפני שאת משנה שוב את התפריט, בדקי מה קורה לשינה, לקפה, למסכים ולרמת הלחץ שלך. לפעמים שם נמצא ההסבר הראשי.',
  },
];
...
function BloatingSection() {
  return (
    <section id="section-bloating" className="guide-section" style={{ background: 'var(--color-surface-elevated)' }}>
      <ChapterHeader
        label="סקשן פתיחה"
        title="לא כל נפיחות נראית אותו דבר"
      ...
      <Reveal>
        <p style={{ fontSize: 15, color: 'var(--color-fg2)', lineHeight: 1.8, marginBottom: 32, maxWidth: 700 }}>
          נפיחות היא סימפטום, לא אבחנה. לפעמים היא קשורה לסוג המזון, לפעמים לקצב האכילה,
          לפעמים לעיכול, למחזור או לעומס ולסטרס. המטרה של החלק הזה היא לעזור לך לזהות
          מה הכי דומה למה שאת חווה, כדי לקרוא את שאר המדריך בצורה מדויקת יותר.
        </p>
      </Reveal>
      <Reveal>
        <div className="side-note" style={{ marginBottom: 36 }}>
          <strong>מילה חשובה לפני שמתחילות:</strong> הרבה נשים מנסות לפתור נפיחות מהר מדי, בלי להבין מה הן בכלל מנסות לפתור.
          ברגע שמזהים את הדפוס הנכון, גם הפעולה הבאה נהיית הרבה יותר ברורה.
        </div>
      </Reveal>
          ...
          <Reveal key={t.id} delay={i * 0.07}>
            <AccordionCard icon={t.emoji} title={t.title} teaser={t.signs[0]} color={t.color}>
              ...
              <div style={{ marginTop: 18, paddingTop: 16, borderTop: '1px solid var(--color-border)' }}>
                <div style={{ fontSize: 12, fontWeight: 700, color: 'var(--color-fg3)', marginBottom: 8 }}>מה כדאי לעשות השבוע</div>
...
const PRINCIPLES = [
  {
    ...
    desc: 'אישה שמתאמנת כוח צריכה בדרך כלל כ-1.5-2 גרם חלבון לקילו משקל גוף ביום. ברוב המקרים כדאי לשלב 20-40 גרם חלבון בארוחה. קפה עם לחמנייה לבדם לרוב לא יספקו שובע ויציבות לאורך זמן.',
    sources: 'ביצים, עוף, הודו, דג (סלמון, טונה, מקרל), יוגורט יווני, קוטג\', טופו, טמפה, עדשים.',
    why: 'חלבון הוא אחד המרכיבים המרכזיים לשובע, לשמירה על מסת שריר ולהתאוששות טובה יותר. אם את לא אוכלת מספיק חלבון, קל יותר להישאר רעבה ולחפש נשנושים בהמשך היום.',
  },
  {
    ...
    why: 'סיבים תומכים בפעילות מעיים תקינה, תורמים לשובע, ומסייעים לאיזון טוב יותר של רמות הסוכר והעיכול. העיקר הוא להעלות אותם בהדרגה ולא בבת אחת.',
  },
  {
    ...
    why: 'שומן טוב מוסיף שובע, תומך בספיגה של ויטמינים מסוימים, ומשתלב היטב בתזונה נשית מאוזנת. המטרה היא לא לפחד ממנו, אלא לבחור אותו נכון ובכמות מתאימה.',
  },
  {
    ...
    why: 'פחמימות מורכבות תורמות לאנרגיה יציבה יותר לאורך היום ומפחיתות נפילות חדות שיכולות להגביר רעב וחשקים.',
  },
  {
...
const FOODS = [
  ...
  { name: 'חזה עוף', cat: 'protein', per: '120-150g', note: 'אורגני אם אפשר' },
...
const BAD_COMBOS = [
  ...
  { title: 'אלכוהול בזמן ארוחה', why: 'אצל חלק מהנשים אלכוהול מכביד על העיכול בזמן הארוחה. אם בוחרת לשתות, עדיף לצד הארוחה ובכמות מתונה.' },
  ...
  return (
    <section id="chapter-1" className="guide-section">
      ...
      <Reveal>
        ...
        <p style={{ fontSize: 15, color: 'var(--color-fg2)', lineHeight: 1.8, marginBottom: 20 }}>
          הבעיה היא שבמשך שנים לימדו נשים להסתכל רק על כמות האוכל, ולא על האיכות שלו, על התזמון שלו,
          ועל האופן שבו הוא משפיע בפועל על שובע, אנרגיה, עיכול ואימון. לכן הרבה נשים אוכלות "מעט",
          אבל עדיין מרגישות נפוחות, עייפות, רעבות או תקועות.
        </p>
        <p style={{ fontSize: 15, color: 'var(--color-fg2)', lineHeight: 1.8, marginBottom: 28 }}>
          הפרק הזה לא נועד לתת לך עוד תפריט נוקשה. הוא נועד ללמד אותך לחשוב נכון על אוכל: איך לבנות ארוחה,
          איך לדעת מה חסר לך בצלחת, ואיך להפסיק לחיות בתחושה שאת כל הזמן או "מצליחה" או "נופלת".
        </p>
      </Reveal>
      <Reveal>
        <div className="card-grid-2" style={{ marginBottom: 44 }}>
          {[
            { title: 'כשאין מספיק חלבון', desc: 'הרעב חוזר מהר, יש יותר נשנושים, וקשה יותר לשמור על יציבות לאורך היום.' },
            { title: 'כשאין מספיק סדר', desc: 'קל מאוד להגיע לערב מותשת, רעבה, ולבחור מתוך לחץ במקום מתוך כוונה.' },
            { title: 'כשאוכלים "בריא" אבל לא מאוזן', desc: 'גם קערת יוגורט או סלט ענק יכולים להשאיר אותך לא מסופקת אם הארוחה לא באמת שלמה.' },
            { title: 'כשיש עקרונות ברורים', desc: 'פתאום הרבה פחות צריך לנחש. את יודעת מה חסר, מה להוסיף, ואיך לאזן גם בימים עמוסים.' },
          ].map((item, i) => (
      ...
      <Reveal delay={0.1}>
        ...
        <div className="side-note">
          אם את מסתבכת, תשאלי את עצמך רק שלוש שאלות לפני שאת אוכלת: איפה החלבון שלי? איפה הירקות שלי?
          והאם יש לי כאן מקור אנרגיה שיחזיק אותי, ולא רק משהו "קטן" שאגרור אחריו רעב בעוד שעה?
        </div>
      </Reveal>
      ...
      <Reveal delay={0.1}>
        <p style={{ fontSize: 14, color: 'var(--color-fg3)', marginBottom: 18, lineHeight: 1.7 }}>
          התפריטים כאן לא נועדו להיות "תפריט קסם", אלא דוגמה לאיך נראה יום שבנוי נכון. את לא חייבת לאכול בדיוק את זה.
          המטרה היא להבין את ההיגיון, ואז להתאים אותו למה שאת באמת אוהבת ויכולה להכין.
        </p>
  ...
  return (
    <section id="chapter-2" className="guide-section" style={{ background: 'var(--color-surface-elevated)' }}>
      <ChapterHeader
        ...
        desc="בריאות המעיים משפיעה על עיכול, אנרגיה, שובע, נוחות בבטן ולעיתים גם על איכות החיים כולה."
      />

      <Reveal>
        <p style={{ fontSize: 15, color: 'var(--color-fg2)', lineHeight: 1.8, marginBottom: 20 }}>
          המעי הוא לא רק חלק ממערכת העיכול. הוא קשור גם למערכת החיסון, ליכולת לפרק מזון,
          לתחושת שובע, לנוחות אחרי ארוחות ולעיתים גם למצב הרוח ולאיכות השינה. כשבריאות המעי
          פחות מאוזנת, זה עשוי להשפיע על הנפיחות, על רמות האנרגיה ועל החשקים לאורך היום.
        </p>
      </Reveal>

      <Reveal>
        <div className="side-note">
          <strong>מה זה מיקרוביום?</strong> קהילה גדולה של מיקרואורגניזמים שחיה במערכת העיכול.
          היא משתתפת בפירוק מזון, בתקשורת עם מערכת החיסון ובתהליכים רבים שמשפיעים על ההרגשה היומיומית.
        </div>
      </Reveal>
      ...
      <Reveal delay={0.1}>
        <p style={{ fontSize: 15, color: 'var(--color-fg2)', lineHeight: 1.8, marginBottom: 20 }}>
          במעי שלך יש אוסף חיידקים שנקרא <Tooltip term="אסטרובולום" definition="שם כללי לחלק מחיידקי המעי שמעורבים בעיבוד ובפינוי של אסטרוגן." />.
          הכבד מעבד אסטרוגן ושולח אותו למעי לפינוי. כשיש חוסר איזון במערכת העיכול, תהליכי הפינוי
          האלה עלולים להיות פחות יעילים.
        </p>
        <p style={{ fontSize: 15, color: 'var(--color-fg2)', lineHeight: 1.8, marginBottom: 24 }}>
          אצל חלק מהנשים זה עשוי להתבטא בנפיחות מחזורית, תחושת כבדות, שינויים ביציאות או החמרה
          של תסמינים סביב הווסת. זה לא אומר שהמעי הוא ההסבר היחיד, אבל לעיתים הוא בהחלט חלק מהתמונה.
        </p>
      ...
      <PullQuote text="כשהמעי פחות מאוזן, זה יכול להשפיע גם על האנרגיה, על השובע ועל החשקים לאורך היום." />
        ...
        <div className="two-col">
          ...
          <div>
            ...
            <div className="side-note" style={{ marginTop: 12 }}>
              במצבים מתמשכים או חריגים כדאי לשקול בירור רפואי מסודר, לפי המלצת רופא.
            </div>
          </div>
        </div>
      </Reveal>
...
const PRINCIPLES_TRAINING = [
  { num: 1, title: 'תנועות מורכבות לפני בידוד', desc: 'סקווט, דדליפט, לחיצות, חתירות, שכיבות סמיכה ומתח הם בסיס מצוין לבניית כוח ומסת שריר. תרגילי בידוד יכולים להשתלב, אבל הם בדרך כלל לא הליבה של התוכנית.' },
  { num: 2, title: 'העמסה הדרגתית', desc: 'כדי להתקדם צריך לייצר לאורך זמן עלייה מדודה בעומס: עוד חזרה, עוד סט או עוד מעט משקל. הגוף מסתגל למה שהוא מקבל באופן קבוע.' },
  ...
  { num: 5, title: 'רישום הוא כלי חשוב', desc: 'בכל אימון כדאי לרשום תרגיל, משקל, חזרות וסטים. אפליקציה או מחברת יעזרו לך לראות התקדמות אמיתית לאורך זמן.' },
];
...
const DAYS = {
  ...
  C: {
    ...
    exercises: [
      ...
      { name: 'Standing Calf Raises', sets: 3, reps: '15-20', rest: '60 שנ\'', muscle: 'שוקיים', technique: 'הרמה מלאה וירידה בשליטה.', tips: 'טווח תנועה מלא.', mistakes: 'חצי טווח.' },
    ]
  },
  D: {
    ...
    exercises: [
      ...
      { name: 'Overhead Tricep Extension', sets: 3, reps: '12-15', rest: '60 שנ\'', muscle: 'טריצפס', technique: 'הארכה מאחורי הראש. מרפקים קרובים.', tips: 'לא לנעול בחלק הגבוה.', mistakes: 'מרפקים זזים לצדדים.' },
  ...
  return (
    <section id="chapter-3" className="guide-section">
      <ChapterHeader
        ...
        desc="אימון כוח הוא אחד הכלים המרכזיים לשיפור הרכב הגוף, ליציבה טובה יותר ולבניית בסיס חזק לאורך שנים."
      />

      <Reveal>
        <div className="side-note" style={{ marginBottom: 40 }}>
          <strong>למה אימון כוח יכול לעזור גם לנפיחות?</strong> הוא תומך ברגישות טובה יותר לאינסולין,
          מסייע בשמירה על מסת שריר, משפר יציבה ויכול להשתלב היטב עם שגרה שמקדמת עיכול ותחושת חיוניות.
        </div>
      </Reveal>
      ...
      <Reveal delay={0.1}>
        <p style={{ fontSize: 15, color: 'var(--color-fg2)', lineHeight: 1.8, marginBottom: 24 }}>
          אצל הרבה נשים יש נטייה להשקיע הרבה בקרדיו ופחות באימון כוח. קרדיו יכול להיות כלי מצוין לבריאות,
          אבל כדי לבנות שריר, לשפר כוח ולעצב את הגוף, צריך לתת מקום מרכזי גם לאימוני התנגדות.
        </p>
...
const STRESS_TOOLS = [
  ...
  { name: 'הליכה ללא טלפון', emoji: '🚶', dur: '20 דקות', color: '#34C759',
    desc: 'בחוץ, בלי טלפון ובלי הסחות. רק את, האוויר והצעדים. זו דרך פשוטה להוריד עומס, להניע את הגוף ולעשות לעצמך מקום לנשום.',
  ...
  return (
    <section id="chapter-4" className="guide-section" style={{ background: 'var(--color-surface-elevated)' }}>
      <ChapterHeader
        ...
        desc="תזונה ואימונים חשובים מאוד, אבל בלי שינה, ניהול עומס והרגלים בסיסיים, הרבה יותר קשה לראות יציבות לאורך זמן."
      />

      <Reveal>
        <p style={{ fontSize: 15, color: 'var(--color-fg2)', lineHeight: 1.8, marginBottom: 32 }}>
          ארבעה עמודי תווך: שינה, סטרס, הידרציה והרגלים יומיומיים. אם את מקפידה במטבח ובחדר הכושר
          אבל כמעט לא ישנה, לא שותה מספיק ונמצאת בעומס קבוע, יהיה קשה יותר להרגיש שינוי יציב.
        </p>
      </Reveal>
      ...
      <Reveal delay={0.1}>
        <div className="card-grid-2">
          {[
            ...
            { icon: '⏰', title: 'מתי לשתות?', desc: 'בוקר: 2 כוסות לפני הקפה. לפני ארוחה: חצי שעה לפני. בזמן הארוחה עדיף לשתות במתינות. לא בלילה מאוחר.' },
            { icon: '❌', title: 'הטעות הכי נפוצה', desc: 'להיזכר לשתות רק כשכבר צמאים. צמא הוא לעיתים סימן מאוחר יחסית, וקפה לא מחליף שתיית מים מסודרת.' },
      ...
      <Reveal delay={0.1}>
        <div className="side-note" style={{ marginBottom: 20 }}>
          אלה אינם תחליף לתזונה, שינה ואורח חיים. חלק מהתוספים עשויים להתאים במצבים מסוימים, ורצוי להתאים אותם באופן אישי.
        </div>
        <div className="card-grid-2">
