    ...
    <section id="chapter-microbiome" className="guide-section">
      ...
      <Reveal>
        <div className="card" style={{ padding: '24px', marginBottom: 24 }}>
          ...
          <p style={{ fontSize: 14, color: 'var(--color-fg2)', lineHeight: 1.85, marginBottom: 12 }}>
            SIBO הוא מצב של גידול יתר של חיידקים במעי הדק - אזור שאמור להכיל הרבה פחות חיידקים מהמעי הגס. זה אבחון שהרבה נשים שומעות, במיוחד סביב IBS, בלי להבין באמת מה המשמעות שלו.
          </p>
          <p style={{ fontSize: 14, color: 'var(--color-fg2)', lineHeight: 1.85, marginBottom: 12 }}>
      ...
      <Reveal>
        <div className="card" style={{ padding: '24px', marginBottom: 24 }}>
          ...
          <p style={{ fontSize: 14, color: 'var(--color-fg2)', lineHeight: 1.85, marginBottom: 12 }}>
            אם עברת לאחרונה קורס אנטיביוטיקה, חשוב לדעת שהחודש שאחרי הוא זמן קריטי לבנייה מחדש של המיקרוביום. אנטיביוטיקה לא מבדילה היטב בין חיידקים בעייתיים לחיידקים טובים, ולכן הרבה נשים מרגישות אחרי טיפול כזה יותר נפיחות, יותר רגישות או יציאות פחות יציבות.
          </p>
          <p style={{ fontSize: 14, color: 'var(--color-fg2)', lineHeight: 1.85, marginBottom: 12 }}>
